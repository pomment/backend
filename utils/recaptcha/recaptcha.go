...
// Modified version of https://github.com/ezzarghili/recaptcha-go
// Now you may use custom reCAPTCHALink URL
...
func NewReCAPTCHA(ReCAPTCHASecret string, version VERSION, timeout time.Duration, reCAPTCHALink string) (ReCAPTCHA, error) {
	if ReCAPTCHASecret == "" {
...
func (r *ReCAPTCHA) Verify(challengeResponse string) (float32, error) {
...
func (r *ReCAPTCHA) VerifyWithOptions(challengeResponse string, options VerifyOption) (float32, error) {
...
func (r *ReCAPTCHA) confirm(recaptcha reCHAPTCHARequest, options VerifyOption) (Score float32, Err error) {
	Score = 0
	Err = nil
